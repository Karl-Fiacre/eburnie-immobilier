...
const devisTypes = [
  { icon: Building, title: "Construction", desc: "Estimation complète pour vos projets de construction neuve à Bonoua et dans tout le Grand Abidjan." },
  ...
  return (
    <>
      <SEOHead
        ...
        description="Obtenez un devis gratuit pour vos projets immobiliers à Bonoua et dans le Grand Abidjan : construction, rénovation, aménagement. Réponse sous 48h par Eburnie Immobilier."
        canonical="/devis"
        keywords="devis immobilier Bonoua, devis construction Abidjan, devis BTP Grand Abidjan, devis rénovation Bonoua, estimation travaux"
        jsonLd={{
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Devis immobilier gratuit à Bonoua et dans le Grand Abidjan",
          "description": "Obtenez un devis gratuit pour vos projets de construction, rénovation ou aménagement immobilier à Bonoua et dans le Grand Abidjan.",
          "provider": {
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-primary via-primary to-secondary py-24 text-primary-foreground">
        ...
        <div className="container relative z-10 text-center">
          ...
          >
            Obtenez une estimation personnalisée et gratuite pour tous vos projets immobiliers à Bonoua et dans le Grand Abidjan. Construction, rénovation, aménagement — nous chiffrons tout.
          </motion.p>
        </div>
      </section>
